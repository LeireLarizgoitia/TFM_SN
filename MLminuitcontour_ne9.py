...
number_elec = 9.0 #number of electrons we want to be produced in IONIZATION
...
with open('ne9_ML_a.txt', "w") as file:
    for x in zip(*c):
        file.write("{0} {1}\n".format(*x))
...
with open('ne9_contour_a.txt', "w") as txt_file:
    for line in grid1:
        content = str(line)
